...
const GitHubIssueSchema = z.object({
  ...
  milestone: z.nullable(z.unknown()),
  comments: z.number(),
  created_at: z.string().datetime(),
  updated_at: z.string().datetime(),
  closed_at: z.nullable(z.string()),
  assignee: z.nullable(z.unknown()),
  ...
  performed_via_github_app: z.nullable(z.unknown()),
  state_reason: z.nullable(z.string()),
  pinned_comment: z.nullable(z.unknown()),
});
...
export type GitHubIssueCommentWebhook = z.infer<typeof GitHubIssueCommentWebhookSchema>;
