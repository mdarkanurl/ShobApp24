...
import { GithubPullRequestReviewEventDto } from "./dto/github-pull_request_review-webhook.dto";
...
type PullRequestReviewEventDataset = {
    event: "pull_request_review";
    data: PullRequestReviewPayload;
}

type PullRequestReviewPayload = GithubPullRequestReviewEventDto;

export class Pull_request_review_event extends BaseEvent<PullRequestReviewPayload> {
    protected readonly eventType = "pull_request_review" as const;

    constructor(prisma?: PrismaClient) {
        super(prisma);
    }

    async Pull_request_review_event(dataset: PullRequestReviewEventDataset): Promise<Class_methods_type> {
        ...
        try {
            ...
            return {
                success: false,
                message: error instanceof Error ? error.message : "Failed to process GitHub pull_request_review event",
                allUpTo: false,
                requeue: true,
            };
        }
    ...
    protected createViewerDataLoader(payload: PullRequestReviewPayload): () => Promise<Actions_function_type> {
