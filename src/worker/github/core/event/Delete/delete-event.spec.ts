...
describe("Delete_event", () => {
  ...
  it("uses the deleted action when running workflows", async () => {
    ...
    const result = await instance.Delete_event({
      event: "delete",
      data: createPayload(),
    } as any);
  ...
  it("returns success when no workflow matches", async () => {
    ...
    await expect(instance.Delete_event({ event: "delete", data: createPayload() } as any))
  ...
  it("marks the workflow run failed when executeActions throws", async () => {
    ...
    const result = await instance.Delete_event({ event: "delete", data: createPayload() } as any);
