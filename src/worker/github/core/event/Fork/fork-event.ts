...
export class Fork_event extends BaseEvent<ForkPayload> {
    protected readonly eventType = "fork" as const;
    ...
    protected createViewerDataLoader(payload: ForkPayload): () => Promise<Actions_function_type> {
